...
Rails.application.configure do
  ...
  # CLI clients (e.g. the Node WebSocket smoke harness) connect without an
  # Origin header; the SPA's Origin is allowed in application.rb. The
  # JWT-in-query auth in ApplicationCable::Connection is the real check.
